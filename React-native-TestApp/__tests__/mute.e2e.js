 ...
 * Mute Tests
 *
 * Tests moderator mute actions: forceMuteAll and forceMuteStream verified via bot state.
...
describe('Mute', () => {
  ...
  beforeAll(async () => {
    ...
    console.log('[muteall] Connecting app...');
    await new Promise((resolve) => setTimeout(resolve, 30000));
    await expect(element(by.id('disconnectSession'))).toBeVisible();
    console.log('[muteall] App connected as moderator.');
    ...
    console.log('[muteall] Bot connected and publishing.');
