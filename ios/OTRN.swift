...
class OTRN : NSObject {
  ...
  var sessionConnectCallbacks = [String: (resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock)]()
  var sessionDisconnectCallbacks = [String: (resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock)]()
